...
<header>
	...
	<div class="pt-5">
		<h2 class="text-center mb-4">ログアウト完了！</h2>
	<div class="text-center">
		<button class="btn-primary rounded-pill w-25" onclick="location.href='login2.php'">ロ グ イ ン 画 面 へ</button>
	</div>
	</div>
